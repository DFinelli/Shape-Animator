 ...
 * calls as it reads a file containing the animation and builds a cs5004.animator.model It is
 * parameterized over the actual cs5004.animator.model type.
 */
...
public interface  TweenModelBuilder<T> {
  ...
  /**
   * cs5004.animator.model.Move the specified shape to the given position during the given time
   * interval.
   *

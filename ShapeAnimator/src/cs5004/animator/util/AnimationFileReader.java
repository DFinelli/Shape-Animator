 ...
 * file in the prescribed file format, and relies on a cs5004.animator.model builder interface.
 * The user of this class should create a cs5004.animator.model builder that implements this
 * interface.
 */
...
public class AnimationFileReader {
  ...
  /**
   * Read the animation file and use the builder to build a cs5004.animator.model.
   *
   * @param fileName the path of the file to be read
   * @param builder  the builder used to build the cs5004.animator.model
   * @param <T>      the type of cs5004.animator.model
   * @return the cs5004.animator.model
